...
var item = (function (philosBase) {
    ...
    item.prototype.loadChild = function(child) {
        ...
        if (name === 'kindleloc') {
            return this.wzLoadToChildColl(child, _md.kindleloc, this.items);
        }
        if (name === 'namespace') {
        ...
        else if (name === 'kindlepage') {
            return this.wzLoadToChildColl(child, _md.kindlepage, this.items);
        }
        if (name === 'opinion-of') {
            return this.wzLoadToChildColl(child, _md.opinionof, this.items);
        }
...
_md.page = page;
// element kindleloc
var kindleloc = (function (item) {
    _inherits(kindleloc, item);
    function kindleloc(name, sourceLineInfo) {
        _get(Object.getPrototypeOf(kindleloc.prototype), 'constructor', this).call(this, name,sourceLineInfo);
        _classCallCheck(this, kindleloc);
        this.wzElement = "kindleloc";
    }
    kindleloc.prototype.toJson = function() {
        var result = {};
        this.toJsonProperties(result);
        this.toJsonChildren(result);
        return result;
    }
    kindleloc.prototype.toJsonProperties = function(result) {
        _md.item.prototype.toJsonProperties.call(this, result);
        if (this.__jsonProps) {
            for (var k in this.__jsonProps) {
                result[k] = this.__jsonProps[k];
    ...
    kindleloc.prototype.toJsonChildren = function(result) {
        _md.item.prototype.toJsonChildren.call(this, result);
    }
    return kindleloc;
})(item);

_md.kindleloc = kindleloc;
// element kindlepage
var kindlepage = (function (item) {
    _inherits(kindlepage, item);
    function kindlepage(name, sourceLineInfo) {
        _get(Object.getPrototypeOf(kindlepage.prototype), 'constructor', this).call(this, name,sourceLineInfo);
        _classCallCheck(this, kindlepage);
        this.wzElement = "kindlepage";
    }
    kindlepage.prototype.toJson = function() {
        var result = {};
        this.toJsonProperties(result);
        this.toJsonChildren(result);
        return result;
    }
    kindlepage.prototype.toJsonProperties = function(result) {
        _md.item.prototype.toJsonProperties.call(this, result);
        if (this.__jsonProps) {
            for (var k in this.__jsonProps) {
                result[k] = this.__jsonProps[k];
    ...
    kindlepage.prototype.toJsonChildren = function(result) {
        _md.item.prototype.toJsonChildren.call(this, result);
    }
    return kindlepage;
})(item);

_md.kindlepage = kindlepage;
// element title
var title = (function (item) {
    _inherits(title, item);
    function title(name, sourceLineInfo) {
...
_md.buy = buy;
_md.__tagElementMapping = { 'extends': 'xextends', 'authors-group': 'authorsgroup', 'co-author': 'coauthor', 'influenced-by': 'influencedby', 'attributed-by': 'attributedby', 'opinion-of': 'opinionof', 'forerunner-of': 'forerunnerof', 'against-approach': 'againstapproach', 'contribution-to': 'contributionto', 'r-concept': 'relatedconcept', 'rconcept': 'relatedconcept', 'against-concept': 'againstconcept', '+': 'text', 'kindle-loc': 'kindleloc', 'kindle-page': 'kindlepage', 'co-editor': 'coeditor', 'back-cover': 'backcover', 'reviewed-work': 'reviewedwork' };
